  ...
  <Accordion>
    <AccordionItem>
      ...
      <p class="text-gray-500 dark:text-gray-400">
        View the <a href="/" target="_blank" rel="noferrer" class="text-blue-600 dark:text-blue-500 hover:underline">manual.</a>
      </p>
      <ul class="list-disc pl-5 dark:text-gray-400 text-gray-500">
        <li>
          <a href="/" target="_blank" rel="noreferrer" class="text-blue-600 dark:text-blue-500 hover:underline"> Start up the machine.</a>
        </li>
        <li>
          <a href="/" target="_blank" rel="noferrer" class="text-blue-600 dark:text-blue-500 hover:underline">Adjust and calibrate the stations.</a>
        </li>
        <li>
          <a href="https://tailwindui.com/" rel="noreferrer" target="_blank" class="text-blue-600 dark:text-blue-500 hover:underline">Clean the glue pot.</a>
        </li>
      </ul>
    </AccordionItem>
    <AccordionItem>
      ...
      <ul class="list-disc pl-5 dark:text-gray-400 text-gray-500">
        ...
        <li>
          <a href="/" target="_blank" rel="noferrer" class="text-blue-600 dark:text-blue-500 hover:underline">View maintenance tasks.</a>
        </li>
        <li>
          <a href="https://tailwindui.com/" rel="noreferrer" target="_blank" class="text-blue-600 dark:text-blue-500 hover:underline"> Prepare a new spoilboard.</a>
        </li>
      </ul>
    </AccordionItem>
    <AccordionItem>
